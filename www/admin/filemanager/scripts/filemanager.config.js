...
var fileConnector = parent.document.getElementById('ROOT').value + '/admin/cms/documents';
//parent.document.location.pathname;

var am = parent.document.location.pathname.substring(1, document.location.pathname.lastIndexOf('/') + 1);
